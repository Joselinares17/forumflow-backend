package org.forumflow.backend.user.infrastructure.exception.handler;

import org.forumflow.backend.user.infrastructure.exception.custom.authentication.ExpiredSessionException;
import org.forumflow.backend.user.infrastructure.exception.custom.authentication.InvalidCredentialsException;
import org.forumflow.backend.user.infrastructure.exception.custom.authentication.InvalidTokenException;
import org.forumflow.backend.user.infrastructure.exception.custom.security.InsufficientPermissionsException;
import org.forumflow.backend.user.infrastructure.exception.custom.security.InvalidRoleException;
import org.forumflow.backend.user.infrastructure.exception.custom.security.PermissionDeniedException;
import org.forumflow.backend.user.infrastructure.exception.custom.security.RoleAssignmentException;
import org.forumflow.backend.user.infrastructure.exception.custom.security.RoleModificationNotAllowedException;
import org.forumflow.backend.user.infrastructure.exception.custom.security.RoleNotFoundException;
import org.forumflow.backend.user.infrastructure.exception.custom.security.UnauthorizedActionException;
import org.forumflow.backend.user.infrastructure.exception.custom.user.InvalidUserInputException;
import org.forumflow.backend.user.infrastructure.exception.custom.user.UserAlreadyExistsException;
import org.forumflow.backend.user.infrastructure.exception.custom.user.UserNotFoundException;
import org.forumflow.backend.user.infrastructure.model.response.ErrorResponse;
